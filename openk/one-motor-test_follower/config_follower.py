...
@RobotConfig.register_subclass("one-motor-test_follower")
@dataclass(kw_only=True)
class OneMotorFollowerConfig(RobotConfig):
    """Static configuration for the OpenK follower arm (ports, safety bounds)."""
